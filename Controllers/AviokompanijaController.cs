...
namespace Aviokompanija.Controllers
{
    ...
    public class AviokompanijaController:ControllerBase
    {
      ...
      //////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////  
        ...
        {
            var avion1=await Context.Airplane.FindAsync(id);
            if (avion1!= null) {
...
/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
        ...
        [Route("DodelaDestinacijeIZakazivanjeLetaAviona/{idDestinacija}/{idAvion}/{Vreme}")] 
        [HttpPost] 
        public async Task<ActionResult> DodelaDestinacijeIZakazivanjeLetaAviona(int idDestinacija,int idAvion,DateTime Vreme,[FromBody] ZakazanLet zakLet)
        {
            var destinacijaPronadjena=await Context.Destination.Where(x=>x.ID==idDestinacija).FirstAsync();
